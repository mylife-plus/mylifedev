    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          Container(padding: EdgeInsets.only(top: 12,bottom: 12),height:66, color: Colors.red.withOpacity(0.1),width: double.infinity,child: Row(
              children: [
                ...selectedHashtags.map((e)=>Padding(
                  padding: const EdgeInsets.only(left: 8.0),
                  child: Chip(
        ...
        SizedBox(height: 8,),
            Container( margin: EdgeInsets.symmetric(horizontal: 12) , height: 48, child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [

                Container(child: Center(child:IconButton(onPressed: (){}, icon: Icon(Icons.close, color: Colors.red), iconSize: 38,),
                ...
                Container(child: Center(child:IconButton(onPressed: (){}, icon: Icon(Icons.check, color: Colors.green), iconSize: 38,),
                ),decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white, boxShadow: [BoxShadow(color: Colors.grey,blurRadius: 3,spreadRadius: 1,offset: Offset(1, 1))]),),
